...
事实上，README中给出的并不是完整的游戏游玩路线，包含真结局在内的，完整的程序如下图所示：
...
D-Side: Died in Spring，标识符DIS，这个标识符隐藏于C-Side的结尾，亦即隐藏在一个名为`.secret`的文本文件中。
...
大概是喝了些啤酒（600cc）的缘故，有一些更加疯狂和合理的想法涌入我的脑海。

如果一切都是虚假的，如何，把这种反复否决的乐趣带给诸位。
...
E-Side/Alter: Eternity Or Falsehood，标识符EOFA，是我想要留给读到这里的创作者们的。



文件读到了末尾，故事还没有结束，这一切究竟是永恒的真理，又或者不过是一个纯粹的谬论？

我把[《关于创作抑郁的研究》](/theory/depression-theory.md)归档到了一个单独的文件中，如果各位感兴趣的话可以读读看。

反复推敲和讨论却没有一个准确的定论，或许只是自己自娱自乐的产物。

如果一时的想法就已经能够带来这么多的东西，我想，如果借助大家的力量一起去思考，或许能够迈向一个新的世界。
...
灵感大概来源于Oneshot，一个部分是退程序，一个部分是换壁纸，这两点vbs都比较好实现。
...
后来发现实际上vbs可以不用关机就能把壁纸换了。

把关机的部分去掉了，改成了重启explorer进程，看上去就像是电脑因为卡刷了一下那种感觉。
