...
|23|转向了ANTI-MARTYR<sup><s>3</s></sup>主义。|
|25|诱发退行性失忆症状，丧失了10月25日的大部分记忆。推测是前一日的ANTI-MARTYR主义的思考，与被推送到禁忌话题<sup><s>4</s></sup>，还有工作压力过大，共同作用下的结果。|
|25~26|（深夜）与Mayflew就死亡的话题聊了一下，理清楚了逻辑<sup>3</sup>，ANTI-MARTYR及相关的延伸内容需要进行重构。|
...
4.这个话题与死亡有关，是“死亡的写实表现”。虽然具体的内容记不清了，但最后结论性的观点大概是：

> 这些东西作为素材只应该出现在解剖学法医的书里，除此以外的出现我认为实在不可理喻。

</s>

<mark>上述两条的观念已经混乱，所以仅记录下来但用删去线标记，不再继续讨论。</mark>

3.与Mayflew讨论之后，得到的结论。
